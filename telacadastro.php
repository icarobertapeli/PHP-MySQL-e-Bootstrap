...
<body>
    <div class="card"> <!-- Card para o formulário -->
        <div class="card-body">
            <div class="d-flex align-items-center justify-content-center mb-3"> <!-- Container para o título e ícone -->
            ...
            <form action="cadastro.php" method="POST"> <!-- Formulário para cadastro -->
                <div class="mb-3">
